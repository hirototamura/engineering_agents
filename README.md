...
| [docs/development-plan.md](docs/development-plan.md) | 開発者 | 未完了機能、ロードマップ、`memo/` 索引 |
...
| `docs/` | 設計・API・シナリオドキュメント（開発プラン含む） |
| `memo/` | 実装プロセス記録・バックログ（[development-plan.md](docs/development-plan.md) から参照） |
