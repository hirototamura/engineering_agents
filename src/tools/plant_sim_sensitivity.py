...
SLIDER_SPECS: Tuple[SliderSpec, ...] = (
    ...
    SliderSpec("actor.policy.ars_goal.initial_co2_mass", "ars_goal.initial_co2_mass", "kg", "float", 0.1, 6.0, 0.05, POLICY_GROUP),
    SliderSpec("actor.policy.ogs_goal.input_water_mass", "ogs_goal.input_water_mass", "kg", "float", 0.01, 1.0, 0.01, POLICY_GROUP),
    SliderSpec("actor.policy.wrs_goal.urine_volume", "wrs_goal.urine_volume", "L", "float", 0.1, 20.0, 0.1, POLICY_GROUP),
    SliderSpec("actor.policy.wrs_feed_trigger_l", "wrs_feed_trigger_l", "L", "float", 0.0, 20.0, 0.1, POLICY_GROUP),
)
