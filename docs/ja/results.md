...
6. **モデル1つ、シード1つ、連鎖3本。** これは3回のランであって統計的な研究ではない。機構が働くこと・働かないことを示すには十分だが、スコアに誤差棒を付けるには足りない。
