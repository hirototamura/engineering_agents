...
前フェーズ: [eps_implementation_plan.md](../scrubber_degradation/eps_implementation_plan.md)（EPS-1〜4 完了）。本ドキュメントは **EPS-5: SSOS ROS2 ブリッジ** として位置づける。
...
| **PR-5** 運用ドキュメント | 📋 backlog | `docs/ssos-eps-integration.md` → [backlog BL-005](../backlog.md#bl-005) |
...
PR-5、Phase 3b/3c、BCDU action、運用ドキュメント等は **[backlog.md BL-005](../backlog.md#bl-005)** に移管。
